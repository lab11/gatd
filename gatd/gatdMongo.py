...
class MongoInterface:
	...
	def __init__ (self, username, password):
		...
		try:
			...
			l.exception('Could not connect to the mongo db'.)
			raise(e)

		except Exception as e:
			l.exception('Unknown error while connecting to mongo db.')
			raise(e)
	...
	def getAllProfiles (self):
		profiles = self.mongo_db['conf_profiles'].find({'deleted': false})
